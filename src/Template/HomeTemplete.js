    ...
    return (
      <div className="row">
        <nav className="nav col-2 flex-column justify-content-center ">
          <NavLink className={({isActive})=>isActive?'nav-link border border-2 border-info-subtle bg-info text-white':'nav-link border border-2 border-dark text-info'} aria-current="page" to="home" >
          <i className="fa-solid fa-house fa-fade "></i> Home <i class="fa-solid fa-arrow-right" style={{position:"relative", top:"0px", left:"81px"}}></i>
          </NavLink>
          <NavLink className={({isActive})=>isActive?'nav-link border border-2 border-success-subtle bg-success text-white':'nav-link border border-2 border-dark text-success'} to="shop">
